...
const ComingEvent = () => {
    return (
        <div>
            ...
            <div className="mt-20">
                <div className="card card-side bg-base-100  shadow-xl m-auto w-10/12 gap-4">
                    <figure><img className="h-96" src="https://i.ibb.co/rs0bTkP/1.jpg" alt="Movie"/></figure>
                    <div className="flex   mt-10 space-x-11   ">
                    
                    <div>
                        <h1 className="  text-7xl text-[#FFB606] font-extrabold">16</h1>
                        <p className="ml-3 text-[#807c7c]">APR, 2023</p>
                    </div>
                    <div className="h-[100px] border-l-[2px] border-l-[#e9edf7] border-solid "></div>
                    <div className=" space-y-5">
                        <h1 className=" text-xl font-extrabold">Social Science & Humanities</h1>
            ...
            <div className="mt-20">
                <div className="card card-side bg-base-100  shadow-xl m-auto w-10/12 gap-4">
                    ...
                    <div>
                        <h1 className="  text-7xl text-[#FFB606] font-extrabold">8</h1>
                        <p className="ml-3 text-[#807c7c]">JUL, 2024</p>
                    </div>
                    <div className="h-[100px] border-l-[2px] border-l-[#e9edf7] border-solid "></div>
                    <div className=" space-y-5">
            ...
            <div className="mt-20">
                <div className="card card-side bg-base-100  shadow-xl m-auto w-10/12 gap-4">
                    ...
                    <div>
                        <h1 className="  text-7xl text-[#FFB606] font-extrabold">16</h1>
                        <p className="ml-3 text-[#807c7c]">AUG, 2024</p>
                    </div>
                    <div className="h-[100px] border-l-[2px] border-l-[#e9edf7] border-solid "></div>
                    <div className=" space-y-5">
