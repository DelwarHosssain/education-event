import '../teacherStyle/teacher.css'
...
const Teacher = ({teacher}) => {
    ...
    return (
    <div className=' mt-10 mb-44 mr-96'>
        <div className="card-client">
            ...
            <div className='border w-40 m-auto my-10'></div>
            <div className="social-media  flex ml-12 space-x-10">
                <a href="#">
